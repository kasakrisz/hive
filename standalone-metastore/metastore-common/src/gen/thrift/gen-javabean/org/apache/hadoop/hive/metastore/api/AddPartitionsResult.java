            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<Partition>(_list614.size);
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (Partition _iter617 : struct.partitions)
            {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (Partition _iter618 : struct.partitions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<Partition>(_list619.size);
          @org.apache.thrift.annotation.Nullable Partition _elem620;
          for (int _i621 = 0; _i621 < _list619.size; ++_i621)
          {
            _elem620 = new Partition();
            _elem620.read(iprot);
            struct.partitions.add(_elem620);
          }
        }
        struct.setPartitionsIsSet(true);
      }
