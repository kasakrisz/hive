...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class ShowLocksResponse implements org.apache.thrift.TBase<ShowLocksResponse, ShowLocksResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list848.size);
                @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem849;
                for (int _i850 = 0; _i850 < _list848.size; ++_i850)
                {
                  _elem849 = new ShowLocksResponseElement();
                  _elem849.read(iprot);
                  struct.locks.add(_elem849);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.locks != null) {
        oprot.writeFieldBegin(LOCKS_FIELD_DESC);
        {
          ...
          for (ShowLocksResponseElement _iter851 : struct.locks)
          {
  ...
  private static class ShowLocksResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<ShowLocksResponse> {
      ...
      if (struct.isSetLocks()) {
        {
          ...
          for (ShowLocksResponseElement _iter852 : struct.locks)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list853 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list853.size);
          @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem854;
          for (int _i855 = 0; _i855 < _list853.size; ++_i855)
          {
            _elem854 = new ShowLocksResponseElement();
            _elem854.read(iprot);
            struct.locks.add(_elem854);
          }
        }
        struct.setLocksIsSet(true);
      }
