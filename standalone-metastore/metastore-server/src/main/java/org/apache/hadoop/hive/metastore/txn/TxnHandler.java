...
abstract class TxnHandler implements TxnStore, TxnStore.MutexAPI {
  ...
  public Materialization getMaterializationInvalidationInfo(
    ...
    Boolean wasUpdated = wasUpdated(checkUpdates, creationMetadata.getValidTxnList(), currentValidTxnListStr);
    if (wasUpdated == null) {
      return null;
    }
  ...
  private Boolean wasUpdated(Collection<String> tableNames, String savedValidTxnListStr, String currentValidTxnListStr)
      throws MetaException {
    if (tableNames.isEmpty()) {
      return false;
    }
