...
public class TestHiveIcebergTimeTravel extends HiveIcebergStorageHandlerWithEngineBase {
  ...
  @Test
  public void testSelectJoinVersionOpenCloseInterval() throws IOException, InterruptedException {
    Table customerTable = testTables.createTableWithVersions(shell, "customers",
        HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA,
        fileFormat, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS, 4);
