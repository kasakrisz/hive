...
public class HiveRelFactories {
  ...
  public static final RelFactories.ValuesFactory HIVE_EMPTY_VALUES_FACTORY =
          new HiveEmptyFactoryImpl();
  ...
  private static class HiveEmptyFactoryImpl implements RelFactories.ValuesFactory {
    @Override
    public RelNode createValues(RelOptCluster cluster, RelDataType rowType, List<ImmutableList<RexLiteral>> tuples) {
      return new HiveEmpty(cluster, rowType, cluster.traitSetOf(HiveRelNode.CONVENTION));
    }
  }
