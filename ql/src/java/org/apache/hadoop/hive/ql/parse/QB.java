...
public class QB {
  ...
  public void setAliasToStartEndTime(String alias, Pair<String, String> fromToTime) {
    this.aliasToFromToTime.put(alias.toLowerCase(), fromToTime);
  }

  public void setAliasToStartEndVersion(String alias, Pair<String, String> fromToVersion) {
