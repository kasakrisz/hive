...
public class QB {
  ...
  private HashMap<String, QBTemporal> aliasToTemporal;
  ...
  public QB(String outer_id, String alias, boolean isSubQ) {
    ...
    aliasToTemporal = new LinkedHashMap<>();
  }
  ...
  public void setAsOf(String alias, QBTemporal qbTemporal) {
    aliasToTemporal.put(alias.toLowerCase(), qbTemporal);
  }
  ...
  public QBTemporal getTemporalForAlias(String alias) {
    return aliasToTemporal.get(alias.toLowerCase());
  }
