...
public class HiveUnionProjectAggregateRewriteRule extends RelOptRule {

  private final HiveRelOptMaterialization materialization;
  private boolean triggered;

  public HiveUnionProjectAggregateRewriteRule(HiveRelOptMaterialization materialization) {
    this( "HiveUnionProjectAggregateRewriteRule", materialization);
  }

  protected HiveUnionProjectAggregateRewriteRule(String description, HiveRelOptMaterialization materialization) {
    super(operand(HiveProject.class, operand(HiveAggregate.class, any())),
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    HiveProject project = call.rel(0);
    HiveAggregate aggregate = call.rel(1);
    RelNode rewritten = rewrite(call, aggregate);
    project.copy(project.getTraitSet(), ImmutableList.of(rewritten));
